...
def main():
    ...
    parser.add_argument(
        ...
        "--pet-data",
        help=
        "Directory containing patients raw data. Will use current working directory if nothing passed",
        type=str,
        default=os.getcwd())
    parser.add_argument(
        "-ct",
        "--ct-data",
        help=
        "Directory containing patients CT data. Will use current working directory if nothing passed",
        type=str,
        default=os.getcwd())
    ...
    patient_info_file = data_path.joinpath(
        f'{project_id}_unanonymized_patient_info.csv')
    ...
    for dirpath, _, ct_files in os.walk(ct_path):
        if ct_files:
            ...
            if move_to:
                ...
                print("StudyInstanceUID in CT not matching any PET data for ",
                      dcm_folder.parent.name)
